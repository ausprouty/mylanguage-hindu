<template>
  <q-page padding>
    ...
    <div v-if="this.videoSegment">
      <div> <VideoPlayer :videoSegment="this.videoSegment" :languageCodeHL="this.languageCodeHL "/></div>
...
<script>
import VideoPlayer from "src/components/JesusVideo/JVideoPlayer.vue";
